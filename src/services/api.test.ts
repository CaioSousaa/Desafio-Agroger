...
describe("API Tests", () => {
  ...
  it("should successfully fetch car brands", async () => {
    const mockResponse = [
      { codigo: "1", nome: "Acura" },
    ...
    expect(mockResponse[0]).toHaveProperty("codigo");
    expect(mockResponse[0]).toHaveProperty("nome");
  });

  it("should return error if the API fails", async () => {
    mock
      .onGet("https://parallelum.com.br/fipe/api/v1/carros/marcas")
      .reply(500);
